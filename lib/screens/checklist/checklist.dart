...
class _ChecklistState extends State<Checklist> {
  ...
  final List<Map<String, dynamic>> checklistItems = [
    ...
    {'category': '필수 소지품', 'item': '모자, 선크림', 'checked': false},
    {'category': '필수 소지품', 'item': '선글라스', 'checked': false},
    {'category': '필수 소지품', 'item': '작은 가방', 'checked': false},
    {'category': '필수 소지품', 'item': '필기도구 / 수첩', 'checked': false},
    ...
    {'category': '외류', 'item': '신발', 'checked': false},
        {'category': '외류', 'item': '슬리퍼', 'checked': false},
            {'category': '외류', 'item': '지퍼백 / 비닐봉투', 'checked': false},
    {'category': '위생 용품', 'item': '세면도구', 'checked': false},
    {'category': '위생 용품', 'item': '생리용품', 'checked': false},

    {'category': '위생 용품', 'item': '개인화장품', 'checked': false},
    {'category': '기타', 'item': '개인의약품', 'checked': false},
    {'category': '기타', 'item': '손목시계', 'checked': false},
    {'category': '기타', 'item': '한국음식', 'checked': false},
    {'category': '기타', 'item': '화장지', 'checked': false},
